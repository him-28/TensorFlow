...
def _job_ready_by_day(now):
    ...
    paths.update({
        ...
        'logic1_output_paths': "{sep}data6{sep}inventory{sep}{year}{sep}{month:02d}{sep}pv2_{day:02d}.csv"\
...
if __name__ == "__main__":
    if sys.argv[1] == 'h':
        ...
        start = time.clock()
        # logic1 code
        infos = merge_file("pv2", paths['logic1_src_paths']["inventory"], paths['logic1_output_paths'], now)
        end = time.clock()
